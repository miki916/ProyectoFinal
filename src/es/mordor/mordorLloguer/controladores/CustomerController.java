...
public class CustomerController implements ActionListener, TableModelListener {
	...
	// Te filtra el arrayList segun lo añadido en el textfield y lo indicado en los
	// combobox
	private void filter() {
		// TODO Auto-generated method stub
	...
	// Abre el JIF de añadir cliente y realiza los actionlistener y actioncommand
			...
			protected Boolean doInBackground() throws Exception {
				...
				try {
					...
					if (e.getErrorCode() == 20005)
						JOptionPane.showMessageDialog(vista, "intentando duplicar una columna/s que son únicas",
								"Error", JOptionPane.ERROR_MESSAGE);
					else if (e.getErrorCode() == 20002)
						JOptionPane.showMessageDialog(vista,
								"Has intentado poner un valor más grande que el permitido por la variable", "Error",
								JOptionPane.ERROR_MESSAGE);
					else if (e.getErrorCode() == 20003)
						JOptionPane.showMessageDialog(vista, "letra en un campo numérico", "Error",
								JOptionPane.ERROR_MESSAGE);
					else
				...
				if (error) {
					...
					fillOracle();
					JOptionPane.showMessageDialog(vista, "Cliente añadido correctamente", "Succes",
							JOptionPane.INFORMATION_MESSAGE);
					vistaAddCustomer.dispose();

				} else

					JOptionPane.showMessageDialog(vista, "Error al añadir al cliente", "Error",
							JOptionPane.INFORMATION_MESSAGE);
