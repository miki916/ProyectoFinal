...
public class Minibus extends Vehicle {
	...
	public Minibus(String registration, float dayPrice, String model, String color, String engine, int displacement,
			Date shopDay, String status, String drivingLicense, int width, int seating) {
